                        ...
                        <table class="table table-bordered table-hover table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $o->stok }}</td>
                                    <td>
                                        <input type="number" name="jumlah[{{ $o->id }}]" value="0" min="0"
                                            max="{{ $o->stok }}" class="form-control"
                                            {{ $o->stok == 0 ? 'disabled' : '' }}>
                                    </td>
                                </tr>
                                @endforeach
                    ...
                    <table class="table table-bordered table-sm mt-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $c->nama_obat }}</td>
                                <td>
                                    <input type="number" name="jumlah[{{ $c->id }}]" value="{{ $c->jumlah }}"
                                        min="0" max="{{ $c->jumlah }}" class="form-control form-control-sm">
                                </td>
                            </tr>
                            @empty
                            <tr>
