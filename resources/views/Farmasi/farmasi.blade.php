    ...
    <div class="pc-content">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Tabel Data Farmasi</h4>

                <div class="d-flex flex-wrap gap-2 mb-3">
                    <a href="{{ route('Farmasi.create') }}" class="btn btn-primary">
                        Create
                    </a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <button class="btn btn-outline-primary btn-sm"
                                            ...
                                            data-bs-target="#modalFarmasi{{ $s->id }}">
                                            View
                                        </button>

                                        <a href="{{ route('Farmasi.edit', $s->id) }}"
                            ...
                            <!-- MODAL DETAIL Farmasi -->
                            <div class="modal fade" id="modalFarmasi{{ $s->id }}" tabindex="-1">
