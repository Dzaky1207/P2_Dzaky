            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body d-flex flex-column">
                        ...
                        <form method="POST" action="{{ route('Antrian.store') }}" class="flex-grow-1 d-flex flex-column justify-content-between">
                            @csrf
                            ...
                            <div class="mb-2">
                                ...
                                <textarea name="catatan_obat" class="form-control"></textarea>
                            </div>
